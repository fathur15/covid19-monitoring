...
class data extends controller
{
    function index()
    {
        ...
        $root = explode('/', ROTT_PATH);
        $root = $root[count($root)-1] == 'htdocs' ? '' : '/covid19' ;
        $data = array(
            ...
            'extra_js' => array(
                ...
                ['file' => file_get_contents(ROTT_PATH .$root.'/public/asset/js/renderingData.js'), 'position' => 'body:akhir', 'tipe' => 'inline']
            ),
            'extra_css' => array(
