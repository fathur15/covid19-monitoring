...
<head>
    ...
    <link rel="stylesheet" href="<?= STATIC_PATH ?>vendor/fontawesome/css/all.css">

    <!-- extra css head -->
    <?php 
        if(sset($extra_css) && !empty($extra_css)){
    ...
    <script src="<?= STATIC_PATH ?>vendor/moment/moment.js"></script>
