        ...
        <div class="container">
            <div class="row content-main-wrapper">   
                ...
                <div  id="resumeGlobal" class="" style="width: 100%; margin: 0 5%;" >
                    <div class="row">
                        <div class="card col-sm-3 shadow-box" style="background: #f50057; align-items: center; height: 120px ">
                            <div class="card-body">
                        ...
                        <div class="card col-sm-3 shadow-box" style="background: #00c853; align-items: center; height: 120px ">
                            <div class="card-body">
                                <div style="flex-direction: row; display: flex; justify-content: center; align-items: center">
