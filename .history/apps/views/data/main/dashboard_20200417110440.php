        ...
        <div class="container">
            ...
            <div class="row content-main-wrapper" >
                ...
                <div id="resumeIndonesia" class="row resume" style="width: 100%; margin: 0 5%;" >
                    <div class="card col-md-3 shadow-box" style="background: #f50057; margin: 5% 0.5%; align-items: center; height: 120px ">
                        <div class="card-body">
                            <div style="flex-direction: row; display: flex; justify-content: center; align-items: center">
                    ...
                    <div class="card col-md-3 shadow-box" style="background: #00c853; margin: 5% 0.5%; align-items: center; height: 120px ">
                        <div class="card-body">
                            <div style="flex-direction: row; display: flex; justify-content: center; align-items: center">
                    ...
                    <div class="card col-md-3 shadow-box" style="margin: 5% 0.5%; height: 120px;align-items: center;  background :#5335b1">
                        <div class="card-body">
                            <div style="flex-direction: row; display: flex; justify-content: center; align-items: center;">
                    ...
                    <div class="card col-md-3 shadow-box" style="margin: 5% 0.5%; height: 120px; background: #f44336">
                        <div class="card-body">
                            <div style="flex-direction: row; display: flex; justify-content: center; align-items: center;">
