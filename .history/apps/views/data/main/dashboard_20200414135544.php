    ...
    <div class="main">
        <div class="container">
            <div class="row content-main-wrapper">   
                ...
                <div id="resumeGlobal" class="" style="width: 100%;" >
                    <div class="row">
                        <div class="card col-sm-3 shadow-box" style=" width: 100% ;background: #f50057; margin: 0.5%; align-items: center; height: 120px ">
                            <div class="card-body">
