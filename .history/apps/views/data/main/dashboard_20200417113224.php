            ...
            <div class="row content-main-wrapper">   
                ...
                <div id="resumeGlobal" class="row resume" style="width: 100%; margin: 0 5%" >
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="width: 100%; background: #f50057; margin:5% 0.5%; align-items: center; height: 120px ">
                                <div class="card-body">
                        ...
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="width:100%; background: #00c853; margin: 5% 0.5%; align-items: center; height: 120px ">
                                <div class="card-body">
                                    <div style="flex-direction: row; justify-content: center; align-items: center">
                        ...
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="width: 100%; margin:5% 0.5%;height: 120px;align-items: center;  background :#5335b1">
                                <div class="card-body">
                                    <div style="flex-direction: row; justify-content: center; align-items: center;">
                        ...
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="width: 100%; margin:5% 0.5%; height: 120px; background: #f44336">
                                <div class="card-body">
                                    <div style="flex-direction: row; justify-content: center; align-items: center;">
