...
<div class="content">
    <div class="heading" style="margin: 100px 30%; text-align: center">
        ...
        <h3>Corona Virus Realtime Data</h3>
        <small style="font-size: 15px">Update every 10 minute </small>
        ...
        <div class="container">
            <div class="row content-main-wrapper">   
                <div class="head-main-content">
                    <h3>Data Global</h3> 
                    <a style="text-decoration: none" href="">Lihat detail <span style="font-size: 30px"> &#x2192 </span>
                        <!-- <i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i> -->
                    </a>
                </div>
                <div id="resumeGlobal" class="row resume" style="width: 100%; margin: 0 5%" >
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="display:inline-block; width: 100%; background: #f50057; margin:1% 0.5%; align-items: center; height: 120px ">
                                <div class="card-body">
                        ...
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="display:inline-block; width:100%; background: #00c853; margin: 1% 0.5%; align-items: center; height: 120px ">
                                <div class="card-body">
                                    <div style="flex-direction: row; display: flex; justify-content: center; align-items: center">
                                        <h5 id="title-kasus-global" class="card-text">Sembuh</h5>
                                        <span class="emot">&#x1F60A</span>
                                    </div>
                        ...
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="display:inline-block; width: 100%; margin: 1% 0.5%;height: 120px;align-items: center;  background :#5335b1">
                                <div class="card-body">
                                    <div style="flex-direction: row; display: flex; justify-content: center; align-items: center;">
                        ...
                        <div class ="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card shadow-box" style="display:inline-block; width: 100%; margin: 1% 0.5%; height: 120px; background: #f44336">
                                <div class="card-body">
                                    <div style="flex-direction: row; display: flex; justify-content: center; align-items: center;">
                                    ...
                                    <div style="display: flex;">
                                        <p style="font-size: 14px" class="card-text" id="kasus-baru-global"></p>
                                        <p style="margin-left: 10%; font-size: 14px" class="card-text" id="meninggal-baru-global"></p>
                                    </div>
                                </div>
                            </div>
                        </div>  
            ...
            <div class="row content-main-wrapper" >
                ...
                <div class="table-responsive-sm">
                    <table id="tbl-statsInd" class="table">
                       <thead>
                            <tr>
                                <th>Tanggal</th>
                                <th>Kasus Baru</th>
                                <th>Jumlah Meninggal Baru</th>
                                <th>Total Kasus</th>
                                <th>Total Sembuh</th>
