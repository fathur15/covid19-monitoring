        ...
        <div class="container">
            <div class="row content-main-wrapper">   
                ...
                <div id="resumeGlobal" class="row" style="width: 100%; margin: 0 5%" >
                        ...
                        <div class="shadow-box card" style="margin:5% 0.5%; width:23%; height: 120px; background: #f44336">
                            <div class="card-body">
                                <div style="flex-direction: row; display: flex; justify-content: center; align-items: center;">
            ...
            <div class="row content-main-wrapper" >
                ...
                <div  id="resumeIndonesia" class="row" style="width: 100%; margin: 0 5%;" >
                    <div class="card shadow-box" style="background: #f50057; width:24%; margin: 5% 0.5%; align-items: center; height: 120px ">
                        <div class="card-body">
                            <div style="flex-direction: row; display: flex; justify-content: center; align-items: center">
