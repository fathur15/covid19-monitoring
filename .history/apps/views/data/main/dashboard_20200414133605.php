...
<div class="content">
    <div class="heading" style="margin: 100px 30%; text-align: center">
        ...
        <h3>Corona Virus Realtime Data <small style="font-size: 18px">Update every 10 minute</small></h3>
    ...
    <div class="main">
        <div class="container">
            <div class="row content-main-wrapper">   
                ...
                <div  id="resumeGlobal" class="" style="width: 90%; display: flex; margin: 0 5%;" >
