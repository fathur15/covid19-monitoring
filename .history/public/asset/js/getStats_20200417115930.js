...
var getCustomStats = function(tipe = 'today', from = 'other'){
    ...
    if(tipe == 'today'){
        ...
        if(from == 'other')
            settings.url = 'https://coronavirus-monitor.p.rapidapi.com/coronavirus/history_by_particular_country_by_date.php?country=Indonesia&date='+start
