var getStatsOfCountry = function(){
    ...
    setTimeout(monitoring(data.responseJSON.latest_stat_by_country[0]), 1000);
    return data;
}
...
var monitoring = function(data){
    ...
    if(data.responseJSON.length == 0){
        var url = window.location.origin == "http://localhost" ? "http://localhost/covid19/ws/stats/tambah/"+data : window.origin +"/ws/stats/tambah/"+data;
        // Cek dari database local 
        var settings = {
            "async": false,
            "crossDomain": true,
